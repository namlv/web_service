...
function appointway_image_resizing($img_url, $width, $height, $crop = true, $quality = 100) {
    ...
    if ($_SERVER['HTTP_HOST'] != $file_path['host'] && $file_path['host'] != '') {  // The image is not locally hosted
        ...
        // We will try to copy the file over locally. Otherwise WP's native wp_get_image_editor() breaks down.

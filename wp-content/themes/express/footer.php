		...
		<div class="container">
			<div class="site-info">
				<p>
					...
					<?php printf( esc_html__( 'Theme: %1$s by %2$s.', 'express' ), '<a href="' . esc_url( 'http://www.yoarts.com/express-free-responsive-magazine-wordpress-theme/' ).'" title="' . esc_attr__( 'Free Responsive Magazine WordPress Theme' ).'">Express</a>', 'YoArts' ); ?><br>
